...
def _load_few_shots(folder_path: str = "few-shot/gsm8k_few_shot/", n_shots: int = 8) -> list:
...
def build_prompt(question: str, folder_path: str = "few-shot/gsm8k_few_shot", n_shots: int = 8,
